...
window.onload = function () {
    ...
    var width = $("#jb_graphite").width(),
        ...
        txt1 = {font: '10px Helvetica, Arial', fill: "blue"},
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        (function (x, y, data, lbl, dot) {
            ...
            rect.hover(function () {
                ...
                label[0].attr({text: data  + (data == 1 ? "" : "s")}).show().stop().animateWith(frame, {translation: [ppp.dx, ppp.dy]}, 200 * is_label_visible);
