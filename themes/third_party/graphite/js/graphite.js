  ...
  /*	if( points.length > 0 ) 
  	{
  		...
  		out_str = '<table id="graphite_log_table">';

  		// We have something to go on! Huzzah. Go for it
  		for (var i = 0; i < points.length; i++)
  		{
  			out_str = out_str + '<tr>';

  			out_str = out_str + '<td>' + points[i] + '</td>';
  			out_str = out_str + '<td>' + legend[i] + '</td>';
  		...
  		// Now, prepend it
  		$that.prepend( out_str );

  		// Great, now toss this over to raphael
  	}*/
