<?php      
      $cache_file =  unserialize(base64_decode($file));
   ...
   ?>                                   
		    ...
		    <script src="<?php echo $theme_path; ?>raphael-min.js"></script>
		    <script src="<?php echo $theme_path; ?>popup.js"></script>
        <script src="<?php echo $theme_path; ?>jquery.js"></script>
		    <script src="<?php echo $theme_path; ?>analytics.js"></script>    
